        ...
        if os.getenv("RENDER"):
            ...
            if combined_text.strip():
                ...
                summary_prompt = PromptTemplate.from_template(
                    "You are an expert document analyst. Read the following excerpts from a newly uploaded document named '{filename}':\n\n{text}\n\nWrite a concise 2-paragraph executive summary capturing the key topics, purpose, and highlights of this document. Make it sound extremely professional and engaging."
                )

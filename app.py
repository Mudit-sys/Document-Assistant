...
st.markdown("Ask detailed questions about your uploaded PDFs — reports, contracts, manuals, papers, and more! Powered by **FAISS**, **LangChain**, and **Meta Llama 3**.")
...
if "messages" not in st.session_state:
    st.session_state.messages = [
        {"role": "assistant", "content": "Hello! I have loaded your documents into the vector space. What would you like to know about them?"}
    ]
